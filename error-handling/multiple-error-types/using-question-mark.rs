...
// Since From::from is a conversion utility between different types, this means that if you ? where
// the error is convertible to the return type, it will convert automatically

...
impl Point {
    // This is a static method, it doesn't need to be called by an instance and are generally used as constructors
    fn origin() -> Point {
        Point { x: 0.0, y: 0.0 }
    }
...
impl Rectangle {
    // This is an instance method, &self is sugar for self: &Self, where Self is the type of the caller object
...
impl Pair {
    // This method consumes the resources of the caller object, selft desugars to self: Self
    fn destroy(self) {

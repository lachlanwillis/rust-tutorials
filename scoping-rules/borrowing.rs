// Most of the time, we'd like to access data without taking ownership
// To accomplish this instead of passing objects by value (T) they can be passed by reference (&T)
